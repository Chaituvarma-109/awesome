...
def post_create_view(request):
    ...
    return render(request, template_name='a_posts/post_create.html', context={'form': form})
...
def post_delete_view(request, pk):
    ...
    if request.method == "POST":
        ...
        return redirect('home')
    return render(request, template_name='a_posts/post_delete.html', context={'post': post})
...
def post_edit_view(request, pk):
    ...
    return render(request, template_name='a_posts/post_edit.html', context=context)
...
def post_page_view(request, pk):
    ...
    if request.htmx:
        ...
        return render(request, 'snippets/loop_postpage_comments.html', context=context)

    context = {'post': post, 'comment_form': comment_form, 'reply_form': reply_form}

    return render(request, template_name='a_posts/post_page.html', context=context)
...
def comment_sent(request, pk):
    ...
    return render(request, "snippets/add_comment.html", context=context)
...
def reply_sent(request, pk):
    ...
    context = {'reply': reply, 'comment': comment, 'reply_form': reply_form }
...
def comment_delete_view(request, pk):
    ...
    return render(request, template_name='a_posts/comment_delete.html', context={'comment': post})
...
def reply_delete_view(request, pk):
    ...
    return render(request, template_name='a_posts/reply_delete.html', context={'reply': reply})
